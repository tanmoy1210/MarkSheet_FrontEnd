...
export const BloodGroupEdit = () => {
    ...
    const navigateTo =  "/BloodGroupList";
    //Fields
    const[bloodGrpName, setbloodGrpName] = useState('');
    const loadCaste = async (e) => {
          ...
          service.ServerAPICall(prm, 'ProcessData').then(response => {
           ...
           if(response != null){
            ...
            console.log('r_object ', response.r_object);
             ...
             setbloodGroupData(responseData);        
             setbloodGrpName(responseData.bloodGroup);
            ...
            <div className="page-bar">
              <div className="page-title-breadcrumb">
                <div className=" pull-left">
                  <div className="page-title">Blood Group</div>
                </div>
                <ol className="breadcrumb page-breadcrumb pull-right">
                  ...
                  <li className="active">Blood Group</li>
                </ol>
              </div>
            </div>
            <div className="row">
                ...
                <div className="card-body" id="bar-parent2">
                  <div className="card card-box">
                    <div className="card-head">
                      <header>Edit Blood Group</header>
                      <button
                        id="panel-button2"
					...
					<div className="form-body">
						...
						<div className="form-group row  margin-top-20">
							<label className="control-label col-md-3">Blood Group Name
							...
							<div className="input-icon right">
                                ...
                                ref={bloodGrpRef}
                                autoComplete="off"
                                onChange={(e) => setbloodGrpName(e.target.value)}
                                value={bloodGrpName}
                                required /> 
                          </div>
						</div>
