...
export const CasteCategoryList = () => {   

    const [casteData, setcasteData] = useState([]);

    const loadCasts = async (e) => {
            ...
            <div className="page-bar">
              <div className="page-title-breadcrumb">
                <div className=" pull-left">
                  <div className="page-title">Caste Category List</div>
                </div>
                <ol className="breadcrumb page-breadcrumb pull-right">
                  ...
                  <li className="active">Cast Category List</li>
                </ol>
              </div>
            </div>
            <div className="row">
                    ...
                    <div className="table-responsive">
                        <table className="table table-hover">
                            <tbody>
                                ...
                                {casteData.map((item) => (
                                <tr key={item.catseCategoryId}>                                  
                                    <td>{item.casteCategory}</td>
                                    <td>                                        
                                        <Link to={`/CasteCategoryEdit/${item.catseCategoryId}`}
                                        className="nav-link nav-toggle">
                                        <i className="fas fa-pencil-alt"></i>
                                        </Link> 
                                     </td>
                                     <td>
                                     <Link to="/CasteCategoryList"  onClick={e => handleDelete(item.catseCategoryId,e)}
                                        className="nav-link nav-toggle">
