...
export const CasteCategoryEdit = () => {
    const { casteCategoryId } = useParams();
    ...
    const navigateTo =  "/CasteCategoryList";
    //Fields
    ...
    const loadCaste = async (e) => {
        ...
        ClientID = getclientID(ClientID);  
          ...
          prm.eventID = "get";
          var data = {
            CatseCategoryId : casteCategoryId
          }
          ...
          service.ServerAPICall(prm, 'ProcessData').then(response => {
           ...
           if(response != null){
            ...
            console.log('r_object ', response.r_object);
             ...
             setcasteData(responseData);        
             setCasteName(responseData.casteCategory);
            ...
            <div className="page-bar">
              <div className="page-title-breadcrumb">
                <div className=" pull-left">
                  <div className="page-title">Caste Category</div>
                </div>
                <ol className="breadcrumb page-breadcrumb pull-right">
                  ...
                  <li className="active">Caste Category</li>
                </ol>
              </div>
            </div>
            <div className="row">
                  ...
                  <div className="card card-box">
					...
					<div className="form-body">
						...
						<div className="form-group row  margin-top-20">
							<label className="control-label col-md-3">Caste Name
